...
| `/smartprobonoip/profile/[id]` | IP Readiness Packet + professional handoff brief |
| `/smartprobonoip/dashboard` | Partner dashboard — filters, demo toggle, CSV export |
| `/smartprobonoip/pilot` | Pilot partner kit with role clarification |
...
6. **IP Readiness Platform** — Path registry, patent Phase 1 education/IDF/handoff upgrades, coming-soon modules for trademark/copyright/trade secret/unsure.
